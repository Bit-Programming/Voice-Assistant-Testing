...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    trackframe.place(x=0,y=0,width=600,height=250)
    ...
    songsframe.place(x=600,y=0,width=600,height=250)
    # Inserting scrollbar
    scrol_y = Scrollbar(songsframe,orient=VERTICAL)
    # Inserting Playlist listbox
    self.playlist = Listbox(songsframe,yscrollcommand=scrol_y.set,selectbackground="gold",selectmode=SINGLE,font=("times new roman",12,"bold"),bg="silver",fg="navyblue",bd=5,relief=GROOVE,height=25)
